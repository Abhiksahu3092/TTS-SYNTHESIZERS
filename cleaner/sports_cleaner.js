...
const raw_data = fs.readFileSync('../data/raw/sports_raw.txt', 'utf8');
...
fs.writeFileSync('../data/cleaned/sports_clean.txt', cleaned.join('।\n'), 'utf8');
fs.writeFileSync('../data/junk/sports_junk.txt', junk.join('।\n'), 'utf8');
