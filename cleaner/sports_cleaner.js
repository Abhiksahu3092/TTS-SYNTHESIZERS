...
const raw_data = fs.readFileSync('../data/raw/sports.txt', 'utf8');
...
fs.writeFileSync('../data/cleaned/sports.txt', cleaned.join('।\n'));
fs.writeFileSync('../data/junk/sports.txt', junk.join('।\n'));